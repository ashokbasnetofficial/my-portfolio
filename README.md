...
## View live demo [here](https:www.basnetashok.com.np).
...
### Customize your details for each component in `src/data` [folder](https://github.com/ashokbasnetofficial/my-portfolio/tree/master/src/data).
